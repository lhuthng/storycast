...
local L = {
  ...
  -- site chrome in the site own voice, and unlike the Storya artifacts the host
  -- knows about, nothing generic will drop it, so this file does. Matched as a
  -- plain find: the first hit is the real one, and a novel that *mentions* the
  -- phrase inside a paragraph would not be cut at it.
