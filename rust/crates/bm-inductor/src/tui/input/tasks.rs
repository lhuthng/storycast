...
pub(crate) async fn key_tasks(app: &mut App, view: TasksView, key: KeyEvent, http: &reqwest::Client, job_tx: &tokio::sync::mpsc::UnboundedSender<Job>) -> bool {
        let mut v = view;
...
pub(crate) async fn key_task_detail(app: &mut App, view: TaskDetail, key: KeyEvent, http: &reqwest::Client, job_tx: &tokio::sync::mpsc::UnboundedSender<Job>) -> bool {
